...
pip install cellbin2==1.2.1
# Install with optional dependencies
pip install cellbin2[cp,rs]==1.2.1      # Editable install with basic extras. Recommended for most users.
pip install cellbin2[cp,rs,rp]==1.2.1   # Editable install including report module.
```
