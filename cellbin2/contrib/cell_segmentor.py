...
class CellSegParam(BaseModel, BaseModule):
    ...
    Transcriptomics_weights_path: str = Field("cellseg_unetpp_RNA_20260129.onnx", description="name of the model")
    Protein_weights_path: str = Field("cellseg_unetpp_RNA_20260129.onnx", description="name of the model")
